        ...
        <q-list>
          ...
          <q-item>
            <q-item-section class="col-12">
              <q-btn rounded style="background-color: red; color: white; padding: 15px" @click="deleteProgram">
                취소하기
              </q-btn>
            </q-item-section>
          </q-item>
...
export default {
  ...
  setup(props, {emit}) {
    ...
    return {sexDict, applyDate, targetDate, deleteProgram, goToAttendancePage}
  }
}
</script>
